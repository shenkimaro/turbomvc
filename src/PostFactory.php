...
/**
 * Factory para criar instâncias do Post apropriadas
...
class PostFactory {
     ...
     * @return PostTraditional
     */
    public static function createTraditional(): PostTraditional {
        return new PostTraditional();
    }
     ...
     * @return PostSwoole
     */
    public static function createSwoole($request = null): PostSwoole {
        $requestObj = new PostSwoole();
     ...
     * @return PostInterface
     */
    public static function createAuto($swooleRequest = null): PostInterface {
