...
class Get {
    ...
    /**
     * Obtém a instância apropriada do Get baseada no ambiente
     * @return GetInterface
     */
    private static function getInstance(): GetInterface {
        if (self::$instance === null) {
            self::$instance = GetFactory::createAuto();
        }
     ...
     * @param GetInterface $instance
     */
    public static function setInstance(GetInterface $instance): void {
     ...
     * @param $key que deve ser passada com Get::getString($key)
    ...
    public static function ehGet(): bool {
        return self::getInstance()->ehGet();
    }
    ...
    /**
     * Retorna todos os parâmetros GET da requisição
     * @return array Array com todos os parâmetros GET da requisição
     */
