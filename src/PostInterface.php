...
/**
 * Interface para implementações de Post
 * Define os métodos que devem ser implementados pelas classes de Post
 */
interface PostInterface {
    
    /**
     * Inicializa o processamento dos parâmetros POST
     * @return void
     */
    public function init(): void;
    
    /**
     * Descriptografa os parâmetros POST
    ...
    /**
     * Retorna um valor inteiro dos parâmetros POST
    ...
    /**
     * Retorna um valor float dos parâmetros POST
     * @param string $key Chave do parâmetro
    ...
    /**
     * Retorna um valor string dos parâmetros POST
     * @param string $key Chave do parâmetro
    ...
    /**
     * Retorna um array dos parâmetros POST
     * @param string $key Chave do parâmetro
     * @return array
     */
    ...
    /**
     * Retorna um valor booleano como string dos parâmetros POST
     * @param string $key Chave do parâmetro
     * @param string|null $defaultValue Valor padrão se não encontrado
     * @return string|null
     */
    ...
    /**
     * Retorna um valor booleano real dos parâmetros POST
     * @param string $key Chave do parâmetro
    ...
    /**
     * Verifica se um parâmetro POST é obrigatório
     * @param string $key Chave do parâmetro
    ...
    /**
     * Remove uma chave dos parâmetros POST
    ...
    /**
     * Retorna todos os parâmetros POST
     * @return array Array com todos os parâmetros POST
     */
