...
class Request {
    ...
    /**
     * Obtém a instância apropriada do Request baseada no ambiente
     * @return RequestInterface
     */
    private static function getInstance(): RequestInterface {
        if (self::$instance === null) {
            self::$instance = RequestFactory::createAuto();
        }
